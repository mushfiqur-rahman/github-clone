      ...
      <div className='bg-[#161b22]'>
        <div className='max-w-[1280px] mx-auto text-[12px] md:flex flex-row-reverse py-6 justify-between items-center px-4'>
          ...
          <ul className='flex items-center mb-4 sm:mb-0 text-[#7d8590] flex-wrap' >
            ...
            <li className='mr-3 '><a href="https://mushfiq.xyz/" target='_blank'>Terms</a></li>
            <li className='mr-3 '><a href="https://mushfiq.xyz/" target='_blank'>Privacy (Updated 08/2022)</a></li>
            <li className='mr-3 '><a href="https://mushfiq.xyz/" target='_blank'>Sitemap</a></li>
            <li className='mr-3 '><a href="https://github.com/mushfiqur-rahman/" target='_blank'>What is Git?</a></li>
          </ul>
        </div>
      </div>
      </div>
